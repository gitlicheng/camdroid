...
enum {
    ...
    CAMERA_MSG_AWMD = 0x8000,	/* MOTION_DETECTION_ENABLE */
    CAMERA_MSG_ADAS_METADATA = 0x10000,	/* for ADAS */
    CAMERA_MSG_TVIN_SYSTEM_CHANGE = 0x20000,
    CAMERA_MSG_QRDECODE = 0x40000,	/* MOTION_DETECTION_ENABLE */
    
    CAMERA_MSG_ALL_MSGS = 0xFFFFF
};
