...
int main(int argc, char **argv)
{
    ...
    printf("hdr.kernel_addr = 0x%x\n",hdr.kernel_addr);
    printf("hdr.ramdisk_addr = 0x%x\n",hdr.ramdisk_addr);
    printf("hdr.second_addr = 0x%x\n",hdr.second_addr);
    printf("hdr.tags_addr = 0x%x\n",hdr.tags_addr);
    ...
    printf("hdr.kernel_size = %d\n",hdr.kernel_size);
    printf("hdr.ramdisk_size = %d\n",hdr.ramdisk_size);
    printf("hdr.second_size = %d\n",hdr.second_size);
