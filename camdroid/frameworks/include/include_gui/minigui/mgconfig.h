...
/* Define if build the sunximin version */
#define SUNXI_MIN 1
...
/* Define if support sunxi raw bitmap fonts */
#define _MGFONT_SXF 1
...
/* Define if include st7167 platform video dirver */
/* #undef _MGGAL_ST7167 */
...
/* Define if include IAL engine for SUNXIKEY */
#define _MGIAL_SUNXIKEY 1
