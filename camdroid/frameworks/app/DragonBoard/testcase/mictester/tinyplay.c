...
void* TinyPlayThread(void* argv)
{
	...
	InitTinyMixer();		// must be done before play music!!!
	do {
...
int main(int argc, char **argv)
{
	...
	char* musicFile = "/mnt/extsd/test_nash.wav";
	char* captureFile = "/mnt/extsd/capture.wav";
	...
	char countDownBuf[3];
	while (capCountDown) {			// capture sound for 20 seconds
		sleep(1);
