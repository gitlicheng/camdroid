...
#ifdef DB_ERROR
#define db_error(...) ALOGE(__VA_ARGS__)
#else
#define db_error(...)
#endif

#ifdef DB_WARN
#define db_warn(...) ALOGW(__VA_ARGS__)
#else
#define db_warn(...)
#endif

#ifdef DB_MSG
#define db_msg(...) ALOGI(__VA_ARGS__)
#else
#define db_msg(...)
#endif
...
#ifdef DB_DEBUG
#define db_debug(...) ALOGD(__VA_ARGS__)
#else
#define db_degbug(...)
#endif

#ifdef DB_VERB
#define db_verb(...) ALOGV(__VA_ARGS__)
#else
#define db_verb(...)
#endif
