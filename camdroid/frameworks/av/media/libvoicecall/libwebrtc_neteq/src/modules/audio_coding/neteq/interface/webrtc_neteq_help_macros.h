...
#define SET_G726_FUNCTIONS(inst) \
                    inst.funcDecode=(WebRtcNetEQ_FuncDecode)WebRtcG726_Decode; \
                    inst.funcDecodeRCU=NULL; \
                    inst.funcDecodePLC=(WebRtcNetEQ_FuncDecodePLC)WebRtcG726_DecodePlc; \
                    inst.funcDecodeInit=(WebRtcNetEQ_FuncDecodeInit)WebRtcG726_DecoderInit; \
                    inst.funcAddLatePkt=NULL; \
                    inst.funcGetMDinfo=NULL; \
                    inst.funcGetPitch=NULL; \
                    inst.funcUpdBWEst=NULL; \
...
#define SET_OPUS_FUNCTIONS(inst) \
                    inst.funcDecode=(WebRtcNetEQ_FuncDecode)WebRtcOpus_DecodeNoneResample; \
                    inst.funcDecodeRCU=NULL; \
                    inst.funcDecodePLC=(WebRtcNetEQ_FuncDecodePLC)WebRtcOpus_DecodePlcNoneResample; \
                    inst.funcDecodeInit=(WebRtcNetEQ_FuncDecodeInit)WebRtcOpus_DecoderInit; \
                    inst.funcAddLatePkt=NULL; \
                    inst.funcGetMDinfo=NULL; \
                    inst.funcGetPitch=NULL; \
                    inst.funcUpdBWEst=NULL; \
                    inst.funcDurationEst=(WebRtcNetEQ_FuncDurationEst)WebRtcOpus_DurationEstNoneResample; \
                    inst.funcGetErrorCode=NULL;
