...
#include <include_omx/OMX_Image.h>
#include <include_omx/OMX_Audio.h>
#include <include_omx/OMX_Video.h>
#include <include_omx/OMX_IVCommon.h>
#include <include_omx/OMX_Other.h>
//#include <libcedarv.h>
#include <vdecoder.h>
...
typedef struct CedarXDemuxerAPI {
  ...
  int  (*prefetch)(struct CedarXDemuxerAPI *handle, CedarXPacket *cdx_pkt);
