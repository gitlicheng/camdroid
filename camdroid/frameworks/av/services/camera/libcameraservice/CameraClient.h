...
public:
    ...
    virtual status_t        setPreviewDisplay(const int hlay);
    //virtual status_t        setPreviewTexture(const sp<ISurfaceTexture>& surfaceTexture);
    virtual status_t        setPreviewTexture(const int hlay);
    ...
    virtual status_t        setWaterMark(int enable, const char *str);
    virtual status_t        setUvcGadgetMode(int value);
    virtual status_t        adasSetGsensorData(int val0, float val1, float val2);
...
private:
    ...
    static status_t         dataCallbackTimestamp(nsecs_t timestamp, int32_t msgType, const sp<IMemory>& dataPtr, int bufIdx, void* user);
    ...
    void                    handleCompressedPicture(const sp<IMemory>& mem, void *metadata);
    void                    handleGenericNotify(int32_t msgType, int32_t ext1, int32_t ext2);
    void                    handleGenericData(int32_t msgType, const sp<IMemory>& dataPtr,
            camera_frame_metadata_t *metadata);
    void                    handleGenericDataTimestamp(nsecs_t timestamp, int32_t msgType, const sp<IMemory>& dataPtr, int bufIdx);
