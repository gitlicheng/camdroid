...
public:
    ...
    virtual status_t        startRecording(const sp<ICameraRecordingProxyListener>& listener, unsigned int recorderId) = 0;
    virtual void            stopRecording(unsigned int recorderId) = 0;
    virtual void            releaseRecordingFrame(const sp<IMemory>& mem, int bufIdx) = 0;
	virtual status_t        setPreviewDisplay(const unsigned int hlay) = 0;
