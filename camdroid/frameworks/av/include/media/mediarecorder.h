...
enum media_recorder_error_type {
	...
	MEDIA_ERROR_BACKUP_BUFFER_OVERFLOW             = 2000,
};
...
enum media_recorder_info_type {
	...
	MEDIA_RECORDER_INFO_EXTRA_FILE_DONE            = 3000,
...
//enum media_recorder_output_sink_type
//{
...
public:
	...
	void dataCallback(int32_t msgType, const sp<IMemory>& imageData, void *metadata);

    //sp<ISurfaceTexture>     querySurfaceMediaSourceFromMediaServer();
    unsigned int     querySurfaceMediaSourceFromMediaServer();
...
private:
    ...
    unsigned int         mLayerMediaSource;
