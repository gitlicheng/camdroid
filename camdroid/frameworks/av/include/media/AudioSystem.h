...
public:
    ...
    static status_t initEchoCancellation(uint32_t bufSize);
    static status_t openEchoCancellation();
    static status_t closeEchoCancellation();
    static status_t releaseEchoCancellation();
