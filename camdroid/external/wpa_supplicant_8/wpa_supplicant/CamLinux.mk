...
include $(LOCAL_PATH)/camlinux.config
...
LOCAL_SHARED_LIBRARIES := libcrypto libssl libc libcutils
LOCAL_CFLAGS := $(L_CFLAGS)
LOCAL_SRC_FILES := $(OBJS_p)
...
PREBUILTS_LIBRARY_PATH := $(TOP)/frameworks/prebuilts
########################
include $(CLEAR_VARS)
