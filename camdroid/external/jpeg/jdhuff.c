        ...
        huffman_offset_data *offset)
{
  ...
  offset->bitstream_offset = jget_input_stream_position(cinfo);
  offset->bitstream_offset =(offset->bitstream_offset << LOG_TWO_BIT_BUF_SIZE)+ entropy->bitstate.bits_left;
        ...
        huffman_offset_data offset)
{
  ...
  int64_t bitstream_offset = offset.bitstream_offset;
  int blkn, i;
