...
def BuildImage(in_dir, prop_dict, out_file):
  ...
  elif fs_type.startswith("squashfs"):
    build_command = ["mksquashfs"]
    if prop_dict.get("mksquashfs_extra_flags", None):	
      build_command.extend(prop_dict["mksquashfs_extra_flags"].split())
    build_command.append(in_dir)
    build_command.append(out_file)
    build_command.append(" -noappend -comp xz")
    if "selinux_fc" in prop_dict:
      build_command.append(prop_dict["selinux_fc"])
