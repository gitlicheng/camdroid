...
$(shell test -d device && find device -maxdepth 6 -name CamLinuxProducts.mk) \
  $(shell test -d vendor && find vendor -maxdepth 6 -name CamLinuxProducts.mk) \
  $(SRC_TARGET_DIR)/product/CamLinuxProducts.mk
endef
