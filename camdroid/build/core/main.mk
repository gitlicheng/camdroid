...
$(warning *  CamLinux can only be built by versions 3.81 and 3.82.)
...
ifneq ($(filter 10.1 10.2 10.3 10.1.% 10.2.% 10.3.% 10.4 10.4.%,$(darwin_version)),)
    $(error Building the CamLinux emulator requires OS X 10.5 or above)
endif
...
ADDITIONAL_BUILD_PROPERTIES += net.bt.name=CamLinux
...
subdir_makefiles := \
	$(shell build/tools/findleaves.py --prune=out --prune=.repo --prune=.git $(subdirs) CamLinux.mk)
