...
#define LOGV(fmt, arg...)	ALOGV("<F:%s, L:%d> " fmt, __FUNCTION__, __LINE__, ##arg)
#define LOGD(fmt, arg...)	ALOGD("<F:%s, L:%d> " fmt, __FUNCTION__, __LINE__, ##arg)
#define LOGI(fmt, arg...)	ALOGI("<F:%s, L:%d> " fmt, __FUNCTION__, __LINE__, ##arg)
#define LOGW(fmt, arg...)	ALOGW("<F:%s, L:%d> " fmt, __FUNCTION__, __LINE__, ##arg)
#define LOGE(fmt, arg...)	ALOGE("<F:%s, L:%d> " fmt, __FUNCTION__, __LINE__, ##arg)
