...
LOCAL_ADDITIONAL_DEPENDENCIES := $(LOCAL_PATH)/CamLinux.mk
...
include $(CLEAR_VARS)
$(call add-prebuilt-files, STATIC_LIBRARIES, unistd_ext.a)
...
LOCAL_ADDITIONAL_DEPENDENCIES := $(LOCAL_PATH)/CamLinux.mk
LOCAL_WHOLE_STATIC_LIBRARIES := libbionic_ssp libc_netbsd unistd_ext
LOCAL_SYSTEM_SHARED_LIBRARIES :=
