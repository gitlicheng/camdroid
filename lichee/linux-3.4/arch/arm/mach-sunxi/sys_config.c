...
extern unsigned int sys_config_size;
extern unsigned int sys_config_addr;
...
{
	script_origin_head_t         *orign_head = __va(sys_config_addr);
...
int __init script_init(void)
{
    ...
    script_origin_head_t        *script_hdr = __va(sys_config_addr);
