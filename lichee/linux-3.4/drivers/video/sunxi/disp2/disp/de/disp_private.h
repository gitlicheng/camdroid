...
struct disp_rotation_sw {
	u32 disp;
	u32 degree;
	disp_rectsz screen_size; // virtual screen_size
	...
	s32 (*apply)(struct disp_rotation_sw *rot_sw, disp_layer_config *lyr_config, disp_rect src_dirty_rect);
	s32 (*checkout)(struct disp_rotation_sw *rot_sw, disp_layer_config *lyr_config);
};
...
extern s32 disp_tv_set_func(struct disp_device*  ptv, disp_tv_func * func);
