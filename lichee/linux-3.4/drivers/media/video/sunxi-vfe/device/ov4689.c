...
//     printk("exp_val = %d,gain_val = %d\n",exp_val,gain_val);
  ...
  /*  if ((gain_val&0x0f00)==0)
		ratio = ((gain_val)&0xff)/128;
	else if ((gain_val&0x0f00)==1)
		ratio = (((gain_val)&0xff)+8)/64;
	else if ((gain_val&0x0f00)==3)
		ratio = (((gain_val)&0xff)+12)/32;
	else if ((gain_val&0x0f00)==7)
		ratio = (((gain_val)&0xff)+8)/16;
