...
struct axp20_config_info{
	...
	int pmu_battery_warning1;
	int pmu_battery_warning2;
	int pmu_chg_stop_temp;
	int pmu_chg_restart_temp;
	int power_start;
	int pmu_irq_io_id;
...
#elif defined CONFIG_AW_AXP152
extern void axp152_power_off(void);
#endif
