...
__s32  burn_boot0_1k_mode_secure( __u32 read_retry_type, __u32 length, __u32 Boot0_buf )
{
	...
	else if(pages_per_block >= 128)
	{
		...
		for( i = NAND_BOOT0_BLK_START;  i < (NAND_BOOT0_BLK_START + NAND_BOOT0_BLK_CNT);  i++ )
	    {
	        ...
	        /* Ã¯Â¿Â½ÃšÂ¿Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½ÃÂ´boot0Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½ */
...
__s32  burn_boot0_lsb_FF_mode(__u32 read_retry_type, __u32 Boot0_buf )
{
   ...
   void* buf;
    ...
    for( i = NAND_BOOT0_BLK_START;  i < (NAND_BOOT0_BLK_START + NAND_BOOT0_BLK_CNT);  i++ )
    {
        ...
        /* Ã”ÃšÂ¿Ã©Ã–ÃÃ‰Ã•ÃÂ´boot0Â±Â¸Â·Ã, lsb modeÃÃ‚Â£Â¬ÃƒÂ¿Â¸Ã¶Â¿Ã©Ã–Â»Ã„ÃœÃÂ´Ã‡Â�?Â¸Ã¶page */
		for( k = 0;  k < 5;  k++ )
		{
			if(k<2)
			{
...
//    __u32 length;
    ...
    debug("burn boot0 1k full page mode!\n");
...
__s32 burn_boot1_in_one_blk(__u32 BOOT1_buf, __u32 length)
{
	...
	/* Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½ÃƒÂ¿Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½page */
	if(length%page_size)
	{
    ...
    for( i = NAND_UBOOT_BLK_START;  i < (NAND_UBOOT_BLK_START + NAND_UBOOT_BLK_CNT);  i++ )
    {
        ...
        /* Ã¯Â¿Â½ÃšÂ¿Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½ÃÂ´boot0Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½, lsb modeÃ¯Â¿Â½Ã‚Â£Ã¯Â¿Â½ÃƒÂ¿Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã–Â»Ã¯Â¿Â½Ã¯Â¿Â½ÃÂ´Ã‡Â�?Ã¯Â¿Â½Ã¯Â¿Â½page */
