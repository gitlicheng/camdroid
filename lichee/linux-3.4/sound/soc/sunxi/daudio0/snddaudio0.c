...
#if defined (CONFIG_ARCH_SUN8IW8) && defined (CONFIG_HDMI_EP952)
extern void audio_config_para(void);
#endif
static int snddaudio_perpare(struct snd_pcm_substream *substream,
	struct snd_soc_dai *dai)
{
	#if defined (CONFIG_ARCH_SUN8IW8) && defined (CONFIG_HDMI_EP952)
	audio_config_para();
