...
typedef struct {
	...
	TCHAR	lfname[128];			/* Pointer to the LFN buffer */
...
#define ioctl_f_getfree   	117
#define ioctl_f_getlabel 	118
#define ioctl_f_setlabel 	119
#define ioctl_f_mkfs  		120
#define ioctl_f_tell		121		// get position
#define ioctl_f_size		122		// get size

#define ioctl_card_status	200
#define ioctl_card_fstype	201
#define ioctl_card_prepare	202

#define ioctl_card_remount	220
#define ioctl_card_format	221
