...
#define POWER20_BAT_VOL_H8              (0x50)
#define POWER20_BAT_VOL_L4              (0x51)
...
#define POWER20_INT_BAT_CHGCUR_H8       (0xA0)
#define POWER20_INT_BAT_CHGCUR_L4       (0xA1)
#define POWER20_EXT_BAT_CHGCUR_H8       (0xA2)
#define POWER20_EXT_BAT_CHGCUR_L4       (0xA3)
#define POWER20_INT_BAT_DISCHGCUR_H8    (0xA4)
#define POWER20_INT_BAT_DISCHGCUR_L4    (0xA5)
#define POWER20_EXT_BAT_DISCHGCUR_H8    (0xA6)
#define POWER20_EXT_BAT_DISCHGCUR_L4    (0xA7)
...
#define POWER20_VREF_TEM_CTRL           (0xF3)
...
#define AXP20_IRQ_EXTLOWARN2  ( 1 << 24)
#define AXP20_IRQ_EXTLOWARN1  ( 1 << 25)
